...
var main_volume: float = 0.50 setget _set_main_volume
var sound_volume: float = 0.50 setget _set_sound_volume
var music_volume: float = 0.50 setget _set_music_volume

var googly_eyes: bool = false
